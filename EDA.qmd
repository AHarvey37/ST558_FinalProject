...
GenBox <- Cleaning1|>
  ...
  gather(key = "Category",value = "val", Age,Education,Income )|>
  select(Diabetes_binary,Category,val)



ggplot(GenBox, aes(Category,val, fill = Category)) +
  geom_boxplot()+
...
trainingVec <- sample(1:nrow(Cleaning1),
                      size = nrow(Cleaning1)*.7)

# Split data into training and test sets
## Training set
diabetesTrain <- Cleaning1[trainingVec,]

## Test set
diabetesTest <- Cleaning1[-trainingVec,]
```
