...
cleaned<- rawData|>
  select(Diabetes_binary,Age,Education,Income,BMI)|>
...
Diabetes_logFit1<-train(Diabetes_binary ~ Age+Income+Education,
                       data = diabetesTrain,
                       method = "glm",
                       trControl = trctrl,
                       metric = "logLoss",
...
Diabetes_logFit2<-train(Diabetes_binary ~ Age+Income+Education,
                       data = diabetesTrain,
                       method = "bayesglm",
                       trControl = trctrl,
                       metric = "logLoss",
...
Diabetes_logFit3<-train(Diabetes_binary ~ Age+Income+Education,
                       data = diabetesTrain,
                       method = "LogitBoost",
                       trControl = trctrl,
                       metric = "logLoss",
